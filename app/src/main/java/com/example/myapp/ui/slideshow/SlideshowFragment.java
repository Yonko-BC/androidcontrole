...
public class SlideshowFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Button login = (Button)rootView.findViewById(R.id.btn);
        TextView res = (TextView) rootView.findViewById(R.id.txtRes);
        EditText nbrEuro = (EditText) rootView.findViewById(R.id.t1);
